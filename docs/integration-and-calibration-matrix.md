...
| ----------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| Greenfield repository with no UI stack          | Proposed next adapter                                          | no CSS entry, no styling dependency, no component manifest                | guidance-only planning until a stack is chosen | generate Design DNA and documentation first; stop before adding framework dependencies                                                                 | choosing or installing Tailwind, shadcn/ui, an icon library, or another component system            |
...
| Existing shadcn/ui project                      | Configuration detection implemented; CLI reuse remains planned | `components.json`                                                         | `shadcn-components`                            | inspect resolved configuration, reuse installed source components and semantic variables, respect aliases, RSC mode, primitive base, and icon library  | initialization, preset changes, registry additions, component overwrite, or dependency installation |
